...
import type { YakuType } from '../game/yaku';

interface YakuCalloutOverlayProps {
  yaku: YakuType | null;
  label: string;
  onComplete: () => void;
}
...
const YAKU_ACCENT: Record<YakuType, string> = {
  godori: colors.gold,
  hongdan: '#E85D4A',
  cheongdan: '#5B9BD5',
  chodan: colors.cream,
...
export function YakuCalloutOverlay({ yaku, label, onComplete }: YakuCalloutOverlayProps) {
